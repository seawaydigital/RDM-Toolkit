...
| `npm test` → `tests/*.test.mjs` | Node built-in `node --test` suite — covers `src/utils/crypto.js` (v2 PBKDF2 format, legacy v1 decrypt compat, rejection-sampling uniformity) |
