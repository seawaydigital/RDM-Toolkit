import { Shield, WifiOff, Wifi, HardDrive, Eye, Server, FileCheck, Lock, Globe, MonitorSmartphone, ArrowRight, ArrowDown, CheckCircle, XCircle, Laptop } from 'lucide-react';
