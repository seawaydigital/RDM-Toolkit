export const CATEGORIES = [
  {
    ...
    tools: [
      ...
      // Security
      { id: 'pdf-redaction', name: 'PDF Redaction', slug: 'redacted', description: 'Permanently remove sensitive content from a PDF \u2014 redacted pages are rasterized so the underlying text can\u2019t be recovered. Suitable for PHIPA, PIPEDA, and TCPS 2 disclosure.', tags: ['pdf', 'privacy', 'security', 'phipa', 'pipeda', 'tcps2'], related: ['pdf-watermark', 'strip-file-metadata', 'data-anonymizer'] },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'to-markdown', name: 'File to Markdown', slug: 'to-markdown', description: 'Convert PDF, HTML, CSV, TXT, Markdown, RTF, and JSON to clean Markdown — ideal for pasting into AI tools.', tags: ['convert', 'markdown', 'pdf', 'csv', 'text', 'ai', 'llm'], related: ['markdown-preview', 'csv-json-converter', 'bibtex-formatter'] },
      // Research-specific
