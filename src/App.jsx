    ...
    function onDrop(e) {
      ...
      if (targetToolId === currentToolId) {
        ...
        if (hasPendingDroppedFiles()) {
          ...
          // editor once a file is loaded, so no listener was mounted.
          // Remount the tool so it starts over on the dropped file —
          // otherwise the drop looks like it did nothing, and the file would
          // be silently loaded by whichever tool is opened next.
